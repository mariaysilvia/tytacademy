...
<body>
    ...
    <section class="form-register">
        ...
        <form>
            <label for="areas">¿Qué competencia desea practicar?:</label>
            <select class="controls" name="areas" id="areas" required>
                <option value="todos">Todos</option>
                <option value="area1">Pensamiento Social</option>
                <option value="area2">Pensamiento sistemico</option>
                <option value="area3">Multiperspectivismo</option>
                </select>
