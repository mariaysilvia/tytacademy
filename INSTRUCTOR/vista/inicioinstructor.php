...
<section class="bannerING contenedor">
    ...
    <div class="bannerING_img">
        <img src="../publico/imagenesinstructor/bannerprofesor.png" alt="">
...
<section id="informacion">
    ...
    <div class="columna1ING">
        ...
        <img class="imagen1ING" src="../publico/imagenesinstructor/enseñanza.jpg" alt="">
    </div>
</section>
<br>
<!--video-->
<section>
    <div class="videoING-container">
        ...
        <video width="800" height="450" controls>
            <source src="../publico/imagenesinstructor/videoinstructores.mp4" type="video/mp4">
...
<div class="columna2ING">
    ...
    <img class="imagen2ING" src="../publico/imagenesinstructor/instruccion.jpg" alt="Instructor enseñando">
</div>
