...
<br>
    ...
    <figure>
        <img
        src="../publico/imagenesinstructor/tarjetasimagenes.jpg"
        />
    </figure>
    <div class="contenidoP-card">
        ...
        <a href="../vista/creaciondelaspruebasTYT.php">Comenzar</a>
    </div>
    </div>
    <div class="cardP">
    <figure>
        <img
        src="../publico/imagenesinstructor/imagenesprueba.jpg"
        />
    </figure>
    <div class="contenidoP-card">
        ...
        <a href="../vista/verlaspruebasTYT.php">Ver más</a>
    </div>
    </div>
    <div class="cardP">
    <figure>
        <img
        src="../publico/imagenesinstructor/pruebaimagenes.jpg"
        />
    </figure>
    <div class="contenidoP-card">
        ...
        <a href="../vista/verlosresultados.php">Ver más</a>
    </div>
    </div>
</div>
