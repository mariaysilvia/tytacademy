...
<section class="bannerGS contenedor">
    ...
    <div class="bannerGS_img">
        <img src="../publico/imagenes/mujernosotros.png" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <img src="../publico/imagenes/galeria1.jpg" class="img-fluid">
...
<section id="componentes">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card-1">
                <img src="../publico/imagenes/Misión.gif" class="card-img-top" alt="Misión">
                <div class="card-body">
                    <br>
        ...
        <div class="col-md-4">
            <div class="card-2">
                <img src="../publico/imagenes/Visión.gif" class="card-img-top" alt="Visión">
                <div class="card-body">
                    <br>
        ...
        <div class="col-md-4">
            <div class="card-3">
                <img src="../publico/imagenes/Valores.gif" class="card-img-top" alt="Valores">
                <div class="card-body">
                    <br>
    ...
    <section id="about-us">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="../publico/imagenes/galeria4.png" class="img-fluid1">
