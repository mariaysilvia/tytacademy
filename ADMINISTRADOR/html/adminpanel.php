...
<main>
      <div class="imagenTYT">
        <img src="../imagenesadmin/tytacademy.png" alt="">
      </div>
        <div class="insights">
...
<div class="top">
  ...
  <div class="theme-toggler">
    ...
    <div class="profile">
      ...
      <div class="profile-photo">
        <img src="../imagenesadmin/administracion-1.jpg" alt=""/>
      </div>
    </div>
</div>
  ...
  <div class="updates">
      <div class="update">
        <div class="profile-photo">
            <img src="../imagenesadmin/administracion-3.jpg" alt=""/>
        </div>
        <div class="message">
      ...
      <div class="update">
        <div class="profile-photo">
        <img src="../imagenesadmin/administracion-4.jpg" alt=""/>
        </div>
      <div class="message">
    ...
    <div class="update">
      <div class="profile-photo">
        <img src="../imagenesadmin/administracion-5.jpg" alt=""/>
      </div>
    <div class="message">
