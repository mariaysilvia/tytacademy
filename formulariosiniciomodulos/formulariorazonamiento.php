...
<body>
    <div id="video-background">
        <video autoplay muted loop>
            <source src="imagenesVideos/RAZONAMIENTO.mp4" type="video/mp4">
        </video>
    </div>
    <section class="form-register">
            <img src="imagenesVideos/tytacademy.png" alt="TYTAcademy">
        </a>
        <h2>¿Quieres prepararte para Razonamiento cuantitativo?</h2>
        ...
        <form action="../simulacropruebas/prueba10razonamiento.html">
            ...
            <select class="controls" name="areas" id="areas" required>
                ...
                <option value="area1">Estadística</option>
                <option value="area2">Geometría</option>
                <option value="area3">Álgebra y cálculo</option>
                </select>
