...
<body>
    <div id="video-background">
        <video autoplay muted loop>
            <source src="imagenesVideos/INGLES.mp4" type="video/mp4">
        </video>
    </div>
    <section class="form-register">
            <img src="imagenesVideos/tytacademy.png" alt="TYTAcademy">
        </a>
        <h2>¿Quieres prepararte para Ingles?</h2>
        <h4>¡Realiza el simulacro de las pruebas TYT de Ingles!</h4>
        <br>
        <h6>Define las caracteristicas de la prueba</h6>
        <form action="../simulacropruebas/prueba10ingles.html">
